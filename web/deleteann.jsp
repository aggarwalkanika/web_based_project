    ...
    <body>
        ...
        <div class="jumbotron">
            <form style="border:6px solid #ccc">
                <div class="ss"> Delete an Announcement </div>
            ...
            try {
                ...
                if (request.getParameter("btsn") != null) {
                    try {
                        ...
                        PreparedStatement st = con.prepareStatement("DELETE FROM announcement WHERE e_name=? AND an_id=?");
                        st.setString(1, name);
                        st.setString(2, id);
        ...
        <div class="container">
            <div class="alert alert-success" align="center">
                <strong>  <strong>Success!</strong>The announcement has been deleted from the database successfully!</strong>   <a href="adminpage.jsp" class="alert-link">Click here.</a>.
            </div>
        </div>
        <%
        } else {
