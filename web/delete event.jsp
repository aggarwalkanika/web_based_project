    ...
    <body>
        ...
        <div class="jumbotron">
            <form style="border:6px solid #ccc">
                <div class="ss"> Remove an event </div>
            ...
            try {
                ...
                if (request.getParameter("btsn") != null) {
                    try {
                        ...
                        PreparedStatement st = con.prepareStatement("DELETE FROM event WHERE e_name=? AND e_id=?");
                        st.setString(1, name);
                        st.setString(2, id);
        ...
        <div class="container">
            <div class="alert alert-success" align="center">
                <strong>  <strong>Success!</strong>The event has been deleted from the database successfully!</strong>   <a href="adminpage.jsp" class="alert-link">Click here.</a>.
            </div>
        </div>
        <%
        } else {
