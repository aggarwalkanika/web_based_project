    ...
    <body>
        ...
        <div class="jumbotron">
            <form style="border:6px solid #ccc">
                <div class="ss"> Registration Page </div>
                        ...
                        <table align="center" class="spac">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="pname" placeholder="Computer Science" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td>
                                        <input type="text" name="pcourse" placeholder="Btech--" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td>
                                        <input type="text" name="pbranch" placeholder="Computer Science" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td>
                                        <input type="text" name="email" placeholder="Computer Science" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
        ...
        <%
            try {
                ...
                String course = request.getParameter("pcourse");
                String branch = request.getParameter("pbranch");
                ...
                if (request.getParameter("btsn") != null) {
                    try {
                        ...
                        int x = st.executeUpdate("insert into registration values('" + pid + "','" + name + "','" + course + "','" + branch + "','" + email + "')");
                        if (x > 0) {
        %>
        <div class="container">
